...
Route::get('/byBranch/{id}', [DashboardController::class, 'byBranch'])->middleware('auth');
Route::get('/byCluster/{id}', [DashboardController::class, 'byCluster'])->middleware('auth');
Route::get('/byLocation/{id}', [DashboardController::class, 'byLocation'])->middleware('auth');
