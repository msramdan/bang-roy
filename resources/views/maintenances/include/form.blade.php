    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="date" name="date" id="date" class="form-control @error('date') is-invalid @enderror"
                value="{{ isset($maintenance) && $maintenance->date ? $maintenance->date : old('date') }}"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="time" name="start_time" id="start-time"
                ...
                value="{{ isset($maintenance) && $maintenance->start_time ? $maintenance->start_time : old('start_time') }}"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="time" name="end_time" id="end-time"
                ...
                value="{{ isset($maintenance) && $maintenance->end_time ? $maintenance->end_time : old('end_time') }}"
