...
@section('title', __('Detail of Certificates'))
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <img src="{{ asset('storage/uploads/images/' . $certificate->image) }}" alt="Image" class="rounded" width="200" height="150" style="object-fit: cover">
                                            @endif
                                        </td>
                                    </tr>
									<tr>
