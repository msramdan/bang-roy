...
@section('title', __('Edit Instances'))
@push('css')
    <style>
        .map-embed {
            width: 100%;
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('instances.update', $instance->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                            ...
                                            @forelse ($operational_times as $i => $operational)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="time"
                                                            ...
                                                            value="{{ old("opening_hour.{$i}") ? old("opening_hour.{$i}") : $operational->open_hour }}"
                                                            autocomplete="off">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" required step="any" class="form-control"
                                                            name="min_tolerance[]" value="{{ $tolerance->min_tolerance }}">
                                                    ...
                                                    <td>
                                                        <input type="number" required step="any" class="form-control"
                                                            name="max_tolerance[]" value="{{ $tolerance->max_tolerance }}">
